...
В отдельном терминале:
    ...
    export JWT_SECRET="supersecret123"   # свой секрет (или через $env)
    uvicorn app:app --host 0.0.0.0 --port 8000 --reload

---------------------------------------
2. Создать первого админа через sqlite3 (сама база .db в .gitignore)
...
Через Swagger:
    ...
    2) В поле "value" ввести:
         Bearer <access_token> (именно с префиксом Bearer и пробелом).
    3) Нажать "Authorize".
